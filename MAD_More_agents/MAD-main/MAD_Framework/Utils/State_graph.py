...
def build_state_graph():
    ...
    builder.add_edge('negative_opening', 'third_part_opening')
    builder.add_edge('third_part_opening', 'moderator_evaluation')
    ...
    builder.add_edge('negative_debater_turn', 'third_debater_turn')
    builder.add_edge('third_debater_turn', 'moderator_evaluation')
