...
def positive_debater_turn(state: DebateState):
    ...
    # Add to negative debater's memory
    state['negative_debater'].add_message(positive_turn)
    return state
...
def negative_debater_turn(state: DebateState):
    ...
    # Add to positive debater's memory
    state['positive_debater'].add_message(negative_turn)
    return state
