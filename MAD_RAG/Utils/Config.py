config = {
    ...
    "debate_prompt": "##oppo_ans##\n\nDo you agree with my perspective? Additionally, you have access to the full debate history for extra context.Do not use JSON or structured formats in your response.",

    "retriever_header": "\n\n Relevant information extracted from the repository:\n"
}

## Mudar o moderador de human pra system prompt
##timestamp no prompt 

# 1 - usar primeira versao de adr (pelo meu dataset)
# 2 - delay de 3 commits
# 3 - 